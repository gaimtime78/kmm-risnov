...
class CreatePenelitiPengabdiKependidikanDiploma2 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('peneliti_pengabdi_kependidikan_diploma2', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('peneliti_pengabdi_kependidikan_diploma2');
    }
}
