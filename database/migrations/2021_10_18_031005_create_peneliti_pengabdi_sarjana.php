...
class CreatePenelitiPengabdiSarjana extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('peneliti_pengabdi_sarjana', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('peneliti_pengabdi_sarjana');
    }
}
