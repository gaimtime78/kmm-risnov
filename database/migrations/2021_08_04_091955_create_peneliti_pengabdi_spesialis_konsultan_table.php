...
class CreatePenelitiPengabdiSpesialisKonsultanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('peneliti_pengabdi_spesialis_konsultan', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('peneliti_pengabdi_spesialis_konsultan');
    }
}
