...
class CreateUsiaProduktifMagisterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('usia_produktif_magister', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('usia_produktif_magister');
    }
}
