...
class CreateTablePenelitiPengabdiKependidikanSpesialis1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('peneliti_pengabdi_kependidikan_spesialis_1', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('table_peneliti_pengabdi_kependidikan_spesialis_1');
    }
}
