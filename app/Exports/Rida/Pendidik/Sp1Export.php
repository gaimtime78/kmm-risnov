...
class Sp1Export implements FromCollection, WithHeadings
{
    ...
    */
    ...
    {
        return UsiaProduktifSP_1::select('fakultas', 'status', 'jenjang', 'periode', 'tahun_input', 'sumber_data', 'usia25sd35_L', 'usia25sd35_P', 'usia25sd35_jumlah', 'usia36sd45_L', 'usia36sd45_P', 'usia36sd45_jumlah', 'usia46sd55_L', 'usia46sd55_P', 'usia46sd55_jumlah', 'usia56sd65_L', 'usia56sd65_P', 'usia56sd65_jumlah', 'usia66sd75_L', 'usia66sd75_P', 'usia66sd75_jumlah', 'usia75_L', 'usia75_P', 'usia75_jumlah', 'total')->where('fakultas', $this->fakultas)->where('tahun_input', $this->tahun)->get();
    }
