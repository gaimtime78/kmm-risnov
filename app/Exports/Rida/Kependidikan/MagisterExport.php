...
class MagisterExport implements FromCollection, WithHeadings
{
    ...
    */
    ...
    {
        return PenelitiPengabdiMagister::select('fakultas', 'status', 'jenjang', 'periode', 'tahun_input', 'sumber_data', 'usia25sd35_L', 'usia25sd35_P', 'usia25sd35_jumlah', 'usia36sd45_L', 'usia36sd45_P', 'usia36sd45_jumlah', 'usia46sd55_L', 'usia46sd55_P', 'usia46sd55_jumlah', 'usia56sd60_L', 'usia56sd60_P', 'usia56sd60_jumlah', 'total')->where('fakultas', $this->fakultas)->where('tahun_input', $this->tahun)->get(); 
    }
