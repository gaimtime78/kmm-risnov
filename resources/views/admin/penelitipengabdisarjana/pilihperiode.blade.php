                  ...
                  @php
                    ...
                    @endphp
                      ...
                      <tr>
                          ...
                          <td>
                            <a href="{{route('admin.penelitipengabdisarjana.details', [$nama_fakultas, $row->periode, $row->tahun_input]  )}}" class="btn" style="background-color: grey;">Detail</a>
                          ...
                          <div id="edit{{$i}}" class="modal modal-fixed-footer">
                            <form action="{{route('admin.penelitipengabdisarjana.update', [$nama_fakultas, $row->periode, $row->tahun_input, $row->sumber_data]  )}}" method="post">
                              @csrf
                          ...
                          <div id="hapus{{$i}}" class="modal">
                            <form action="{{route('admin.penelitipengabdisarjana.delete', [$nama_fakultas, $row->periode, $row->tahun_input]  )}}" method="get">
                              @csrf
                              <div class="modal-content">
                                <h4>Hapus Tabel</h4>
                                <hr>
