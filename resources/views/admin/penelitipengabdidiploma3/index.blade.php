            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                @foreach ($nama_table as $name) 
                  <form action="{{route('admin.penelitipengabdidiploma3.updateNamaTable', [$name->nama_table] )}}" method="post" enctype="multipart/form-data" >
                    @csrf
                ...
                <div id="import" class="modal">
                  <form action="{{route('admin.penelitipengabdidiploma3.import')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content">
                      <h4>Import Data</h4>
                      <p>Untuk import data melalui excel, silahkan download template excel dan sesuaikan masukan</p>
                      <a href="{{asset('template\rida\table_peneliti_pengabdi_diploma3.xlsx')}}">Download template</a>
                        <h5><label for="penelitipengabdidiploma3s" class="form-label">Upload file excel</label></h5>
                  ...
                  <tbody>
                    ...
                    @foreach ($penelitipengabdi as $row)
                      <tr>
                          ...
                          <td><a href="{{route('admin.penelitipengabdidiploma3.pilihperiode' , $row->fakultas )}}" class="btn" style="background-color: grey;">Detail</a></td>
                      </tr>
                      @php
                        $i++;
                      @endphp
