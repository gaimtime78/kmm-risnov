                ...
                <div class="container">
                    <div class="section">
                        ...
                        <div id="table-datatables">
                            ...
                            <h4 class="header left">DOKUMENTASI KETERLIBATAN DALAM KEGIATAN PENELITIAN DAN PENGABDIAN JENJANG DIPLOMA 3
                                {{ $fakultas }}</h4>
                                            ...
                                            @foreach ($penelitipengabdi as $row)
                                                <tr>
                                                    ...
                                                    <div id="edit{{ $row->id }}" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.penelitipengabdidiploma3.updaterow', $row->id) }}"
                                                            method="post">
                                                            @csrf
