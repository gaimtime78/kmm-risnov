                                            ...
                                            <thead>
                                                <tr style="border: 1px solid black !important;">
                                                    <th rowspan="3"
                                                        ...
                                                        No</th>
                                                    <th rowspan="3" style="text-align:center !important;">Jenis</th>
                                                    <th rowspan="3"
                                                ...
                                                @foreach ($data as $row)
                                                    <tr style="border: 1px solid black !important;">
                                                        ...
                                                        <td
                                                            ...
                                                            {{ $row->jenis }}</td>
                                                        <td style="border: 1px solid black !important;"><a href="{{ route('admin.skemanonpnbp.details-jenis', ['jenis' => $row->jenis, 'periode' => $periode, 'tahun_input' => $tahun]) }}"
