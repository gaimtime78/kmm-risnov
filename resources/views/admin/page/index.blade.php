                ...
                <div class="container">
                    <div class="section">
                        ...
                        <div id="table-datatables">
                            ...
                            <a href="{{ route('admin.page.create') }}" class="waves-effect waves-light btn-large right"><i
                                    class="mdi-content-add left"></i>Tambah Page</a>
                            <div class="row">
                                <div class="col s12 m12 l12">
                                            ...
                                            @foreach ($pages as $page)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="actionBtn"
                                                            action="{{ route('admin.page.delete', [$page->id]) }}"
                                                            method="post">
                                                            @method('delete')
                                                            @csrf
                                                            <button type="submit"
