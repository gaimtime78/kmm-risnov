                ...
                <div class="container">
                    <div class="section">
                        ...
                        <div id="table-datatables">
                            ...
                            <h4 class="header left">ENTANG USIA PRODUKTIF TENAGA PENDIDIK JENJANG SPESIALIS-1 {{ $fakultas }}</h4>
                                            ...
                                            @foreach ($usiaproduktifsp_1 as $row)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        {{ $row->total }}</td>
                                                    @if ($x++ == 0)
                                                        <td rowspan="{{ count($usiaproduktifsp_1) }}"
                                                            style="border: 1px solid black !important; text-align:center !important;">
                                                    ...
                                                    <div id="edit{{ $row->id }}" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.usiaproduktifsp_1.updaterow', $row->id) }}"
                                                            method="post">
                                                            @csrf
