      ...
      <div class="container">
        <div class="section">    
          ...
          <div id="table-datatables">
              ...
              <h4 class="header left">TABEL RENTANG USIA PRODUKTIF TENAGA PENDIDIK JENJANG MAGISTER {{ $nama_fakultas}} </h4>
                  ...
                  @php
                    ...
                    @endphp
                      ...
                      <tr>
                          ...
                          <td>
                            <a href="{{route('admin.usiaproduktifmagister.details', [$nama_fakultas, $row->periode, $row->tahun_input]  )}}" class="btn" style="background-color: grey;">Detail</a>
                          ...
                          <div id="edit{{$row->id}}" class="modal modal-fixed-footer">
                            <form action="{{route('admin.usiaproduktifmagister.update', [$nama_fakultas, $row->periode, $row->tahun_input, $row->sumber_data]  )}}" method="post">
                              @csrf
                          ...
                          <div id="hapus{{$row->id}}" class="modal">
                            <form action="{{route('admin.usiaproduktifmagister.delete', [$nama_fakultas, $row->periode, $row->tahun_input]  )}}" method="get">
                              @csrf
                              <div class="modal-content">
                                <h4>Hapus Tabel</h4>
                                <hr>
