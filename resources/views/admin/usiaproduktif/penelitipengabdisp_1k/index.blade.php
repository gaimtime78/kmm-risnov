                ...
                <div id="import" class="modal">
                  <form action="{{route('admin.usiaproduktifsp_1k.import')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                      ...
                      <a href="{{asset('template\rida\table_4_usiaproduktifspesialiskonsultan.xlsx')}}">Download template</a>
                        <h5><label for="usiaproduktifsp_1k" class="form-label">Upload file excel</label></h5>
                        <input type="file" name="usiaproduktifsp_1k">
                ...
                <table id="data-menu" class="table display" cellspacing="0">
                  ...
                  <tbody>
                    @php
                      $i = 1;
                    @endphp
                      @foreach ($usiaproduktifsp_1k as $row)
                      <tr>
                          <td>{{$i}}</td>
                          <td>{{$row->fakultas}}</td>
                         
                          <td><a href="{{route('admin.usiaproduktifsp_1k.pilihperiode' , $row->fakultas )}}" class="btn" style="background-color: grey;">Detail</a></td>
                      </tr>
                      @php
                        $i++;
                      @endphp
