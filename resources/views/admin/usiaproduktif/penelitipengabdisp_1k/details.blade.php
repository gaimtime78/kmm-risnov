                ...
                <div class="container">
                    <div class="section">
                        ...
                        <div id="table-datatables">
                            ...
                            <h4 class="header left">RENTANG USIA PRODUKTIF TENAGA PENDIDIK JENJANG SPESIALIS-1 (KONSULTAN)																		
                                {{ $fakultas }}</h4>
                                            ...
                                            @foreach ($usiaproduktifsp_1k as $row)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        {{ $row->total }}</td>
                                                    @if ($x++ == 0)
                                                        <td rowspan="{{ count($usiaproduktifsp_1k) }}"
                                                            style="border: 1px solid black !important; text-align:center !important;">
                                                    ...
                                                    <div id="edit{{ $row->id }}" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.usiaproduktifsp_1k.updaterow', $row->id) }}"
                                                            method="post">
                                                            @csrf
