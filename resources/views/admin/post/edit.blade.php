...
<div id="main">
	...
	<div class="wrapper">
		...
		<div id="table-datatables">
			<h4 class="header">Edit Berita</h4>
			<div class="row">
				<div class="col12">
						...
						<div class="row">
							...
							<form method="POST" action="{{ route('admin.post.delete', ['id' => $data->id]) }}">
								...
								<div class="input-field col right">
									<button class="btn danger waves-effect waves-light right" type="submit" name="action">DELETE
										<i class="mdi-content-delete right"></i>
									</button>
								</div>
							</form>
						</div>
						<div class="row">
							<form class="col s12" method="post" action="{{ route('admin.post.update', ['id' => $data->id]) }}">
								@csrf
								@method('put')
								<div class="row">
									<div class="input-field col s12">
										<input id="name" name="title" type="text" value="{{ $data->title }}" />
										<label for="first_name">Judul</label>
									</div>
								</div>
								<div class="row">
									<div class="input-field col s12">
										<textarea id="tinymce" name="content">{{ $data->content }}</textarea>
										<label for="message">Konten</label>
									</div>
									<div class="row">
										<div class="input-field col s12">
											<button class="btn green waves-effect waves-light right" type="submit" name="action">Update
