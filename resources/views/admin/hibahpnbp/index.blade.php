                ...
                <div class="container">
                    <div class="section">
                        ...
                        <div id="table-datatables">
                            <h4 class="header left">Tabel 24  @foreach ($nama_table as $name) {{ $name->nama_table }} @endforeach </h4>
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    ...
                                    <form action="{{route('admin.hibahpnbp.updateNamaTable', [$name->nama_table] )}}" method="post" enctype="multipart/form-data" >
                                        @csrf
                                            ...
                                            @foreach ($hibahpnbps as $row)
                                                <tr>
                                                    ...
                                                    <div id="edit{{ $i }}" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.hibahpnbp.update', [$row->periode, $row->tahun_input, $row->sumber_data]) }}"
