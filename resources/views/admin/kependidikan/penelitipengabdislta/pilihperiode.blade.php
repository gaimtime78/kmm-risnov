                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.penelitipengabdikependidikanslta.details', [$nama_fakultas, $row->periode, $row->tahun_input]) }}"
                                                    ...
                                                    <div id="edit" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.penelitipengabdikependidikanslta.update', [$nama_fakultas, $row->periode, $row->tahun_input, $row->sumber_data]) }}"
                                                            method="post">
                                                            @csrf
                                                    ...
                                                    <div id="hapus" class="modal">
                                                        <form
                                                            action="{{ route('admin.penelitipengabdikependidikanslta.delete', [$nama_fakultas, $row->periode, $row->tahun_input]) }}"
                                                            method="get">
                                                            @csrf
                                                            <div class="modal-content">
                                                                <h4>Hapus Tabel</h4>
