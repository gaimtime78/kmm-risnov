            ...
            <div class="container">
                <div class="section">
                    ...
                    <div id="table-datatables">
                        ...
                        <h4 class="header left">Tabel X RENTANG USIA PRODUKTIF PENELITI DAN PENGABDI TENAGA KEPENDIDIKAN
                            JENJANG SPESIALIS 1
                            {{ $fakultas }}</h4>
                        <div class="row">
                            <div class="col s12 m12 l12">
                                        ...
                                        @foreach($penelitipengabdispesialis1 as $row)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    {{ $row->total }}</td>
                                                @if($x++ == 0)
                                                    <td rowspan="{{ count($penelitipengabdispesialis1) }}"
                                                        style="border: 1px solid black !important; text-align:center !important;">
                                                ...
                                                <div id="edit{{ $row->id }}" class="modal modal-fixed-footer">
                                                    <form
                                                        action="{{ route('admin.penelitipengabdikependidikanspesialis1.updaterow', $row->id) }}"
                                                        method="post">
                                                        @csrf
