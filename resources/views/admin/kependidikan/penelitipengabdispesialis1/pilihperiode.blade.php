            ...
            <div class="container">
                <div class="section">
                    ...
                    <div id="table-datatables">
                        ...
                        <h4 class="header left">Tabel 7 RENTANG USIA PRODUKTIF PENELITI DAN PENGABDI TENAGA KEPENDIDIKAN
                            JENJANG SPESIALIS 1
                            {{ $nama_fakultas }} </h4>
                        <div class="row">
                            <div class="col s12 m12 l12">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($data as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.penelitipengabdikependidikanspesialis1.details', [$nama_fakultas, $row->periode, $row->tahun_input]) }}"
                                                ...
                                                <div id="edit{{ $i }}" class="modal modal-fixed-footer">
                                                    <form
                                                        action="{{ route('admin.penelitipengabdikependidikanspesialis1.update', [$nama_fakultas, $row->periode, $row->tahun_input, $row->sumber_data]) }}"
                                                        method="post">
                                                        @csrf
                                                ...
                                                <div id="hapus{{ $i }}" class="modal">
                                                    <form
                                                        action="{{ route('admin.penelitipengabdikependidikanspesialis1.delete', [$nama_fakultas, $row->periode, $row->tahun_input]) }}"
                                                        method="get">
                                                        @csrf
                                                        <div class="modal-content">
                                                            <h4>Hapus Tabel</h4>
