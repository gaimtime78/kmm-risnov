      ...
      <div class="container">
        <div class="section">    
          ...
          <div id="table-datatables">
            <h4 class="header left">Tabel 13 @foreach ($nama_table as $name) {{ $name->nama_table }} @endforeach</h4>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                @foreach ($nama_table as $name) 
                  <form action="{{route('admin.penelitipengabdikependidikandiploma1.updateNamaTable', [$name->nama_table] )}}" method="post" enctype="multipart/form-data" >
                    @csrf
