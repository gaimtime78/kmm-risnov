                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.penelitipengabdikependidikansarjana.details', [$nama_fakultas, $row->periode, $row->tahun_input]) }}"
                                                    ...
                                                    <div id="edit" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.penelitipengabdikependidikansarjana.update', [$nama_fakultas, $row->periode, $row->tahun_input, $row->sumber_data]) }}"
                                                            method="post">
                                                            @csrf
