                                            ...
                                            @foreach ($penelitipengabdisltp as $row)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        {{ $row->total }}</td>
                                                    @if ($x++ == 0)
                                                        <td rowspan="{{ count($penelitipengabdisltp) }}"
                                                            style="border: 1px solid black !important; text-align:center !important;">
                                                    ...
                                                    <div id="edit{{ $row->id }}" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.penelitipengabdikependidikansltp.updaterow', $row->id) }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input value="{{ $row->usia25_L }}" id="usia25_L"
                                                                            name="usia25_L" type="text" class="validate"
                                                                            required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input value="{{ $row->usia25_P }}" id="usia25_P"
                                                                            name="usia25_P" type="text" class="validate"
                                                                            required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input value="{{ $row->usia60_L }}"
                                                                            id="usia60_L" name="usia60_L"
                                                                            type="text" class="validate" required>
                                                                        <label for="usia60_L">Usia >60 L</label>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input value="{{ $row->usia60_P }}"
                                                                            id="usia60_P" name="usia60_P"
                                                                            type="text" class="validate" required>
                                                                        <label for="usia60_P">Usia >60 P</label>
                                                                    </div>
                                                                </div>
