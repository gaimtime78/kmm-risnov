                ...
                <div class="container">
                    <div class="section">
                        ...
                        <div id="table-datatables">
                            <h4 class="header left">Tabel 15 RENTANG USIA PRODUKTIF PENELITI DAN PENGABDI TENAGA
                                KEPENDIDIKAN JENJANG SLTP
                            </h4>
                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    ...
                                    <!-- <a href="{{ route('admin.penelitipengabdikependidikansltp.export') }}" class="waves-effect waves-light btn right" role="button">Export Excel</a> -->

                                    {{-- Modal import --}}
                                    <div id="import" class="modal">
                                        <form action="{{ route('admin.penelitipengabdikependidikansltp.import') }}"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <p>Untuk import data melalui excel, silahkan download template excel dan
                                                    sesuaikan masukan</p>
                                                <a
                                                    href="{{ asset('template\rida\table_15_peneliti_pengabdi_kependidikan_sltp.xlsx') }}">Download
                                                    template</a>
                                                <h5><label for="penelitipengabdisltp" class="form-label">Upload file excel</label></h5>
                                                <input type="file" name="penelitipengabdisltp">
                                    ...
                                    <table id="data-menu" class="table display" cellspacing="0">
                                        ...
                                        <tbody>
                                            @php
                                                $i = 1;
                                            @endphp
                                            @foreach ($penelitipengabdisltp as $row)
                                                <tr>
                                                    <td>{{ $i }}</td>
                                                    <td>{{ $row->fakultas }}</td>
                                                    <td><a href="{{ route('admin.penelitipengabdikependidikansltp.pilihperiode', $row->fakultas) }}"
