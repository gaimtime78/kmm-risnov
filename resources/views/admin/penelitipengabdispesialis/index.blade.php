      ...
      <div class="container">
        <div class="section">    
          ...
          <div id="table-datatables">
            <h4 class="header left">Tabel 19 @foreach ($nama_table as $name) {{ $name->nama_table }} @endforeach </h4>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                @foreach ($nama_table as $name) 
                  <form action="{{route('admin.penelitipengabdispesialis.updateNamaTable', [$name->nama_table] )}}" method="post" enctype="multipart/form-data" >
                    @csrf
                ...
                <div id="import" class="modal">
                  <form action="{{route('admin.penelitipengabdispesialis.import')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                      ...
                      <a href="{{asset('template\rida\table_19_spesialis-2.xlsx')}}">Download template</a>
                        <h5><label for="penelitipengabdispesialis" class="form-label">Upload file excel</label></h5>
