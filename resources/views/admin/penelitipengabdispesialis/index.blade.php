                  ...
                  <tbody>
                    ...
                    @endphp
                      ...
                      <tr>
                          ...
                          <td><a href="{{route('admin.penelitipengabdispesialis.pilihperiode' , $row->fakultas )}}" class="btn" style="background-color: grey;">Detail</a>   <a href="#hapus" class="btn modal-trigger" style="background-color: red;">Delete</a></td>
                          <!-- Modal Hapus -->
