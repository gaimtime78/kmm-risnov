          ...
          <div id="table-datatables">
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <a href="{{route('admin.penelitipengabdispesialis1.export')}}" class="waves-effect waves-light btn right" role="button">Export Excel</a>

                {{-- Modal import --}}
                <div id="import" class="modal">
                  <form action="{{route('admin.penelitipengabdispesialis1.import')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content">
                      <h4>Import Agenda</h4>
                      <p>Untuk import table 4 melalui excel, silahkan download template excel dan sesuaikan masukan</p>
                  ...
                  <tbody>
                    ...
                    @endphp
                      ...
                      <tr>
                          ...
                          <td><a href="{{route('admin.penelitipengabdispesialis1.details' , $row->fakultas )}}" class="btn" style="background-color: grey;">Detail</a>   <a href="#hapus" class="btn modal-trigger" style="background-color: red;">Delete</a></td>
                          <!-- Modal Hapus -->
                          <div id="hapus{{$row->id}}" class="modal">
                            <form action="{{route('admin.penelitipengabdispesialis1.delete', [$row->fakultas])}}" method="get">
                              @csrf
                              <div class="modal-content">
                                <h4>Delete Agenda</h4>
                                <hr>
