                ...
                <div class="container">
                    <div class="section">
                        ...
                        <div id="table-datatables">
                            ...
                            <h4 class="header left">Tabel 21 RENTANG USIA PRODUKTIF PENELITI DAN PENGABDI JENJANG SP-1 (K)
                                {{ $fakultas }}</h4>
                                            ...
                                            @foreach ($penelitipengabdispesialis1 as $row)
                                                <tr>
                                                    ...
                                                    <div id="edit{{ $row->id }}" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.penelitipengabdispesialis1.updaterow', $row->id) }}"
                                                            method="post">
                                                            @csrf
