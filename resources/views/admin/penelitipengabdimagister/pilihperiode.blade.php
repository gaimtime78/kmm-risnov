      ...
      <div class="container">
        <div class="section">    
          ...
          <div id="table-datatables">
              ...
              <h4 class="header left">Tabel 2 RENTANG USIA PRODUKTIF PENELITI DAN PENGABDI JENJANG MAGISTER {{ $nama_fakultas}} </h4>
                  ...
                  @php
                    ...
                    @endphp
                      ...
                      <tr>
                          ...
                          <td><a href="{{route('admin.penelitipengabdimagister.details', [$nama_fakultas, $row->periode, $row->tahun_input]  )}}" class="btn" style="background-color: grey;">Detail</a>   <a href="#hapus" class="btn modal-trigger" style="background-color: red;">Delete</a></td>
                          <!-- Modal Edit -->
