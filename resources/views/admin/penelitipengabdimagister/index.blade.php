      ...
      <div class="container">
        <div class="section">    
          ...
          <div id="table-datatables">
            <h4 class="header left">Tabel 18 @foreach ($nama_table as $name) {{ $name->nama_table }} @endforeach </h4>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                @foreach ($nama_table as $name) 
                  <form action="{{route('admin.penelitipengabdimagister.updateNamaTable', [$name->nama_table] )}}" method="post" enctype="multipart/form-data" >
                    @csrf
                ...
                <div id="import" class="modal">
                  <form action="{{route('admin.penelitipengabdimagister.import')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content">
                      <h4>Import Data</h4>
                      <p>Untuk import data melalui excel, silahkan download template excel dan sesuaikan masukan</p>
                      <a href="{{asset('template\rida\table_18_peneliti_pengabdian_magister.xlsx')}}">Download template</a>
                        <h5><label for="penelitipengabdimagister" class="form-label">Upload file excel</label></h5>
