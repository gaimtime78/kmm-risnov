      ...
      <div class="container">
        <div class="section">    
          ...
          <div id="table-datatables">
            ...
            <h4 class="header left">Tabel 2 RENTANG USIA PRODUKTIF PENELITI DAN PENGABDI JENJANG DOKTOR {{ $fakultas}}</h4>
                ...
                <table id="data-menu" class="table display" cellspacing="0">
                  <thead>
                      <tr>
                          ...
                          <th style="border: 1px solid black !important; text-align:justify !important;">Total Percent %</th>
                  ...
                  @php
                    ...
                    @endphp
                      ...
                      <tr >
                          ...
                          @if( $x++ == 0)
                          <td  rowspan="{{count($penelitipengabdi)}}"  style="border: 1px solid black !important; text-align:center !important;">{{number_format((float)$totalpercent, 2, '.', '')}} %</td>
                          @endif
                        ...
                        <thead>
                          <tr>
                            ...
                            <th style="border: 1px solid black !important;text-align:center !important;">{{$sum25sd35_jumlah}}</th>
                            <th style="border: 1px solid black !important;text-align:center !important;">{{$sum36sd45_jumlah}}</th>
                            <th style="border: 1px solid black !important;text-align:center !important;">{{$sum46sd55_jumlah}}</th>
                            <th style="border: 1px solid black !important;text-align:center !important;">{{$sum56sd65_jumlah}}</th>
                            <th style="border: 1px solid black !important;text-align:center !important;">{{$sum66sd75_jumlah}}</th>
                            <th style="border: 1px solid black !important;text-align:center !important;">{{$sum75_jumlah}}</th>
                            <th style="border: 1px solid black !important;text-align:center !important;">{{$total}}</th>
                          </tr>
