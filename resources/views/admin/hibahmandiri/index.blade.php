                ...
                <div class="container">
                    <div class="section">
                        ...
                        <div id="table-datatables">
                            <h4 class="header left">Tabel 56  @foreach ($nama_table as $name) {{ $name->nama_table }}  @endforeach </h4>
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    ...
                                    <a href="{{route('admin.hibahmandiri.5edisi')}}" class="waves-effect waves-light btn right modal-trigger" role="button">Detail 5 Edisi Terakhir</a>
                                    {{-- Modal update nama table --}}
                                    <div id="update_nama_table" class="modal">
                                        @foreach ($nama_table as $name)
                                        <form action="{{route('admin.hibahmandiri.updateNamaTable', [$name->nama_table] )}}" method="post" enctype="multipart/form-data" >
                                            @csrf
                                    ...
                                    <div id="import" class="modal">
                                        <form action="{{ route('admin.hibahmandiri.import') }}" method="post"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h5><label for="hibahmandiri" class="form-label">Upload file
                                                        excel</label></h5>
                                                <input type="file" name="hibahmandiri">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($hibah as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.hibahmandiri.details',[ $row->periode, $row->tahun_input]) }}"
                                                    ...
                                                    <div id="edit{{ $i }}" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.hibahmandiri.update', [$row->periode, $row->tahun_input, $row->sumber_data]) }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="modal-content">
                                                                <h4>Edit Data</h4>
                                                    ...
                                                    <div id="hapus{{ $i }}" class="modal">
                                                        <form
                                                            action="{{ route('admin.hibahmandiri.delete', [$row->periode, $row->tahun_input]) }}"
                                                            method="get">
                                                            @csrf
                                                            <div class="modal-content">
                                                                <h4>Delete Data</h4>
