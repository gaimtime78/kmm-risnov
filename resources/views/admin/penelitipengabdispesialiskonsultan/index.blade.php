      ...
      <div class="container">
        <div class="section">    
          ...
          <div id="table-datatables">
            <h4 class="header left">Tabel 20 RENTANG USIA PRODUKTIF PENELITI DAN PENGABDI JENJANG SPESIALIS-1 (K)
</h4>
                ...
                <div id="import" class="modal">
                  <form action="{{route('admin.penelitipengabdispesialiskonsultan.import')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                      ...
                      <a href="{{asset('template\rida\table_20_peneliti_pengabdi_sp-1(k).xlsx')}}">Download template</a>
