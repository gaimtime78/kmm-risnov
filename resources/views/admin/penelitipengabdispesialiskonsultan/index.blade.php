          ...
          <div id="table-datatables">
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <a href="{{route('admin.penelitipengabdispesialiskonsultan.export')}}" class="waves-effect waves-light btn right" role="button">Export Excel</a>

                {{-- Modal import --}}
                <div id="import" class="modal">
                  <form action="{{route('admin.penelitipengabdispesialiskonsultan.import')}}" method="post" enctype="multipart/form-data">
                    @csrf
                  ...
                  <tbody>
                    ...
                    @endphp
                      ...
                      <tr>
                          ...
                          <td><a href="{{route('admin.penelitipengabdispesialiskonsultan.details' , $row->fakultas )}}" class="btn" style="background-color: grey;">Detail</a>   <a href="#hapus" class="btn modal-trigger" style="background-color: red;">Delete</a></td>
                          <!-- Modal Hapus -->
