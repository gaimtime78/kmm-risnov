                ...
                <table id="data-menu" class="table display" cellspacing="0">
                  <thead>
                      <tr>
                          ...
                          <th style="border: 1px solid black !important; text-align:justify !important;">  > 75 L</th>
                  ...
                  @php
                      ...
                      $x = 0;
                    @endphp
                      @foreach ($penelitipengabdispesialiskonsultan as $row)
                      <tr>
                          ...
                          @if( $x++ == 0)
                          <td  rowspan="{{count($penelitipengabdispesialiskonsultan)}}"  style="border: 1px solid black !important; text-align:center !important;">{{number_format((float)$totalpercent, 2, '.', '')}} %</td>
                          @endif
