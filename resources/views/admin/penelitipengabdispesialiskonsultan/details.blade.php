                ...
                <div class="container">
                    <div class="section">
                        ...
                        <div id="table-datatables">
                            ...
                            <h4 class="header left">Tabel 20 RENTANG USIA PRODUKTIF PENELITI DAN PENGABDI JENJANG SP-1 (K)
                                {{ $fakultas }}</h4>
                                            ...
                                            @foreach ($penelitipengabdispesialiskonsultan as $row)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        {{ $row->total }}</td>
                                                    @if ($x++ == 0)
                                                        <td rowspan="{{ count($penelitipengabdispesialiskonsultan) }}"
                                                            style="border: 1px solid black !important; text-align:center !important;">
                                                    ...
                                                    <div id="edit{{ $row->id }}" class="modal modal-fixed-footer">
                                                        <form
                                                            action="{{ route('admin.penelitipengabdispesialiskonsultan.updaterow', $row->id) }}"
                                                            method="post">
                                                            @csrf
