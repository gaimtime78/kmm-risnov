      ...
      <div class="container">
        <div class="section">    
          ...
          <div id="table-datatables">
              ...
              <h4 class="header left">Tabel 6 RENTANG USIA PRODUKTIF PENELITI DAN PENGABDI JENJANG PROFESI {{ $nama_fakultas}} </h4>
                  ...
                  @php
                    ...
                    @endphp
                      ...
                      <tr>
                          ...
                          <td><a href="{{route('admin.penelitipengabdiprofesi.details', [$nama_fakultas, $row->periode, $row->tahun_input]  )}}" class="btn" style="background-color: grey;">Detail</a>   <a href="#hapus" class="btn modal-trigger" style="background-color: red;">Delete</a></td>
                          <!-- Modal Edit -->
