                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data_peneliti_pengabdi_sarjana as $row)
                                                <tr>
                                                    ...
                                                    <td
                                                    style="border: 1px solid black !important; text-align:center !important;">
                                                    <a href="{{ route ('rida-Grafik Usia Produktif Sarjana',['jenjang'=> $row->jenjang]) }}" class="btn" style="background-color: #43cae9 ;">Detail</a>
                                                </td>
                                            </tr>
                                            @php
                                            $i++;
                                            ...
                                            @foreach ($data_kerjasama_penelitian as $row)
                                                <tr>
                                                    ...
                                                    <td
                                                    style="border: 1px solid black !important; text-align:center !important;">
                                                    <a href="{{ route ('rida-kerjasama-penelitian') }}" class="btn" style="background-color: #43cae9 ;">Detail</a>
                                                </td>
                                            </tr>
                                            @php
                                            $i++;
                                        ...
                                        @endforeach
                                            ...
                                            @foreach ($data_research_grup as $row)
                                                <tr>
                                                    ...
                                                    <td
                                                    style="border: 1px solid black !important; text-align:center !important;">
                                                    <a href="{{ route ('rida-research_grup') }}" class="btn" style="background-color: #43cae9 ;">Detail</a>
                                                </td>
                                            </tr>
                                            @php
                                            $i++;
                                            ...
                                            @foreach ($data_akreditasi_pusdi as $row)
                                                <tr>
                                                    <td
                                                    style="border: 1px solid black !important; text-align:center !important;">
                                                    {{ $i }}</td>
                                                    ...
                                                    <td
                                                    style="border: 1px solid black !important; text-align:center !important;">
                                                    <a href="{{ route ('rida-akreditasi_pusdi') }}" class="btn" style="background-color: #43cae9 ;">Detail</a>
                                                </td>
                                            </tr>
                                            @php
                                            $i++;
