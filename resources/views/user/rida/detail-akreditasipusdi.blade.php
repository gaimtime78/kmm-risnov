        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tagline-message page-title text-center">
                    <h3 style="color:black">@foreach($nama_table as $f) {{ucwords($f->nama_table)}} @endforeach </br> {{$pusat_studi}} </h3>
                </div>
            </div><!-- end col -->
        </div><!-- end row -->
    </div><!-- end container -->
                                    ...
                                    <table id="data-menu" class="table display" cellspacing="0" style="border-collapse: collapse !important;">
                                        <thead>
                                            <tr style="border: 1px solid black !important;">
                                                ...
                                                <th rowspan="4" style="border: 1px solid black !important; text-align:center !important; vertical-align:middle !important;">Pusat Studi</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($status_akreditasi as $row)
