                                ...
                                <div class="blog-meta">
                                    ...
                                    <div class="tags-widget">
                                        <ul class="list-inline">
                                            @foreach ($post->category()->pluck('category')->toArray()
        as $cc)
                                ...
                                @if ($post->show_thumbnail)
                                    <div class="blog-media">
                                        <img src="{{ asset('upload/post/' . $post->thumbnail) }}" alt=""
                                ...
                                <div class="blog-desc-big">
                                    ...
                                    <div class="row blog-grid" style="margin-top:6em;">
                                                ...
                                                <div class="course-box">
                                                    <div class="image-wrap entry">
                                                        <img style="height:200px;object-fit:cover;"
                                                            src="{{ asset('upload/post/' . $gal->file) }}" alt=""
                                                            class="img-responsive">
                                                        <div class="magnifier">
                                                            <a onclick="showModal(`{{ asset('upload/post/' . $gal->file) }}`)"
                                        ...
                                        @if ($post->video_url)
                                            @foreach ($urls as $url)
                                            <div class="col-md-4"><iframe width="320" height="180"
                                                src="{{ $url }}">
                                            </iframe></div>
                                            @endforeach
                                        @endif
                                    ...
                                    <ul class="list-inline">
                                        <li><i class="fa fa-clock-o"></i> Dipublikasikan pada :
                                            {{ date('d M Y', strtotime($post->published_at)) }}</li><br>
                                        <li><i class="fa fa-user"></i><span> Penulis : </span> <a
