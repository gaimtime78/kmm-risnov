        ...
        <div class="container">
            ...
            <form action="{{ route('admin.page.update', [$page->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    @if ($page->use_post == 1)
                        <input class="form-check-input" type="radio" name="useAsPost" id="useAsPost1" value=1 checked>
                    ...
                    @else
                        ...
                        <label class="form-check-label" for="useAsPost1">Ya</label>
                        <input class="form-check-input" type="radio" name="useAsPost" id="useAsPost0" value=0 checked>
                        <label class="form-check-label" for="useAsPost1">Tidak</label>
                    @endif
                </div>
                <div class="mb-3">
